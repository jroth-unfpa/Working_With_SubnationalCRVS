---
title: "Woking with the `SubnationalCRVS` R Package"
author: "Created by: Jeremy Roth"
date: 'Last Updated: 7 July 2020'
output:
  pdf_document:
    number_sections: yes
    toc: yes
...
- `name.month2` is the name of variable that provides the month of the laterof the two time periods represented in `data`. Here we specify `name.month2="month2"` (the value of this variable, `"11"` was the numerical month, November, of Ecuador's 2010 Census)

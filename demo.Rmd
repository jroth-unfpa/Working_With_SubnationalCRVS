...
ageheaping_with_Noumbissi <- ComputeAgeHeapingScores(data=ecuador_single_year_ages_combined,
                                      name.disaggregations="province_name",
                                      name.males="m",
                                      name.females="f",
                                      name.age="age",

...
```
## age ratios
```{r, "age_ratios", message=FALSE, warning=FALSE}
...
```{r, "age_heaping", message=FALSE, warning=FALSE}
...
## age heaping scores
```{r, "age_heaping_scores", message=FALSE, warning=FALSE}
ah <- PlotAgeHeapingScores(data=ecuador_age_tabulation,
                                      name.disaggregations="province",
                                      name.males="m",
                                      name.females="f",
                                      name.age="age",
...
```{r, "estimate_DDM", message=FALSE, warning=FALSE}
...
```{r, "plot_DDM", message=FALSE, warning=FALSE}

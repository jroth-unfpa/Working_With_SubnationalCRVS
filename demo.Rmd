...
PlotDDM(ddm_results=ddm_results,
        label.completeness="Estimated Adult Death Registration Completeness (%)",
...
Additionally, `PlotDDM` presents a visualization of the GGB-SEG estimates of adult death-registration completeness to the all permitted values of the age range (i.e. sensitivity) that is selected `DDM::ddm()` as part of the fitting procedure underlying its estimation.
